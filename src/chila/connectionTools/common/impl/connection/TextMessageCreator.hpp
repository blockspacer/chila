...
#ifndef CHILA_CONNECTIONTOOLS_COMMON_IMPL_CONNECTION__TEXTMESSAGECREATOR_HPP
#define CHILA_CONNECTIONTOOLS_COMMON_IMPL_CONNECTION__TEXTMESSAGECREATOR_HPP
