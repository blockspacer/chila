...
#ifndef CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONNECTIONPERFORMER_HPP
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONNECTIONPERFORMER_HPP
...
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARG_ALIAS_SEQ \
    (clientId) \
    (recvBuffer) \
    (sndBuffer) \
    (errorMsg) \
...
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONN_ALIAS_SEQ \
    (Network)(Logger)(MessageProcessor)

#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONN_ALIAS_AALINK_SEQ_Network \
    ((clientId)(clientId)) \
...
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONN_ALIAS_AALINK_SEQ_Logger \
    ((clientId)(clientId)) \
    ((recvBuffer)(recvBuffer)) \
    ((sndBuffer)(sndBuffer)) \
    ((errorMsg)(errorMsg)) \
...
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONN_ALIAS_AALINK_SEQ_MessageProcessor \
...
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__APCREATORS_SEQ \
    (networkNameProv)(processingNameProv)(procMessageCreator)(procMessageReaderPC)

// networkNameProv
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_RARG_SEQ_networkNameProv

#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_PARG_SEQ_networkNameProv \
    (moduleName)

// processingNameProv
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_RARG_SEQ_processingNameProv

#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_PARG_SEQ_processingNameProv \
    (moduleName)

// procMessageCreator
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_RARG_SEQ_procMessageCreator \
    (clientId)(recvBuffer)

#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_PARG_SEQ_procMessageCreator \
    (procMessage)

// procMessageReaderPC
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_RARG_SEQ_procMessageReaderPC \
    (procMessage)

#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARGPROV_PARG_SEQ_procMessageReaderPC \
    (clientId)

// ----------------------------- Connector instances utility macros ---------------------------------------
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__CONN_INSTANCE_SEQ \
    ((Logger)(logger)) \
...
CHILA_LIB_MISC__DEF_NAMESPACE(6, (chila,connectionTools,appTest,app,connectors,gen))
{
    ...
    {
        static chila::lib::misc::Path path() { return "chila.connectionTools.appTest.app.connectors.gen.ConnectionPerformer"; }

        // ArgAliases
        struct ArgAliases
        {
            CHILA_CONNECTIONTOOLS_LIB_CODEGEN__DEF_ARG_ALIASES(CHILA_CONNECTIONTOOLS_APPTEST_APP_CONNECTORS_GEN__ARG_ALIAS_SEQ)
        };
        ...
        <
            ...
            typename Action_messageProcessor_start,
        ...
        struct Ex_network_started
        {
            ...
            Action_messageProcessor_start act_messageProcessor_start;
            ...
            (
                ...
                const Action_messageProcessor_start &act_messageProcessor_start,
                const Action_network_acceptClient &act_network_acceptClient
            ) :
                apc_networkNameProv(apc_networkNameProv),
                act_logger_moduleStarted(act_logger_moduleStarted),
                act_messageProcessor_start(act_messageProcessor_start),
            ...
            ) const
            {
                ...
                // messageProcessor.actions.start
                EXECUTE_ACTION
                (
...
<
        ...
        static void connect_network(ConnInstances &cInstances, const Providers &providers)
        {
            ...
            (
                ...
                actionExecuter<Tag_network_started, 1>(cInstances.messageProcessor.actions.start),
                actionExecuter<Tag_network_started, 2>(cInstances.network.actions.acceptClient)
            );
