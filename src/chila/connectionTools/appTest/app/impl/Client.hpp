...
#ifndef CHILA_CONNECTIONTOOLS_APPTEST_APP_IMPL__CLIENT_HPP
#define CHILA_CONNECTIONTOOLS_APPTEST_APP_IMPL__CLIENT_HPP
...
MY_NSP_START
{
    class Client
    {
        public:
            ...
            {
                BufferSPtr buffer = std::make_shared<Buffer>(1024);
            ...
            {
                BufferSPtr sndBuffer = std::make_shared<Buffer>(*buffer);
                sndBuffer->push_back('\n');
