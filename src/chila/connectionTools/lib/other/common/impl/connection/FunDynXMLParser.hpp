...
#ifndef CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_IMPL_CONNECTION__FUNDYNXMLPARSER_HPP
#define CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_IMPL_CONNECTION__FUNDYNXMLPARSER_HPP
