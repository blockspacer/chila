...
//../../../../src/chila/connectionTools/lib/other/common/impl/macros.fgen.py
#ifndef MY_NSP_START\

    #define MY_NSP_START \
        CHILA_LIB_MISC__DEF_NAMESPACE_VAR(chila,connectionTools,lib,other,common,impl)

    #define MY_NSP_END \
        CHILA_LIB_MISC__CLOSE_DEF_NAMESPACE_VAR(chila,connectionTools,lib,other,common,impl)
    ...
    #define MOD_ACTION_SIG(action) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__CONNECTOR_ACTION_SIG(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, MODULE_NAME, action)

    #define APROV_DEF_PROVIDER_BASE_FOR(prov) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROV_DEF_PROVIDER_BASE_FOR(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov)

    #define APROV_DEF_PROVIDER_BASE_FOR_WC(prov, customArgs) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROV_DEF_PROVIDER_BASE_FOR_WC(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov, customArgs)

    #define APROV_CONS_PARAMS_FOR(prov) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROV_CONS_PARAMS_FOR(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov)

    #define APROV_PASS_REQ_PARAMS_FOR(prov) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROV_PASS_REQ_PARAMS_FOR(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov)

    #define APROV_DEF_CREATOR_WITH_ARGS(prov, argSeq) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROV_DEF_CREATOR_WITH_ARGS(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov, argSeq)

    #define APROV_COMMA_IF_HAS_CONS_PARAMS_FOR(prov) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROV_COMMA_IF_HAS_CONS_PARAMS_FOR(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov)
    ...
    #define DEF_APC_ENCAPSULATOR_CR(creatorName, readerName, EncType) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__DEF_APC_ENCAPSULATOR_CR(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, creatorName, readerName, EncType)

    #define APROVIDER_DEC_EX(prov, customArgs) \
        CHILA_CONNECTIONTOOLS_LIB_OTHER__APROVIDER_DEC_EX(CHILA_CONNECTIONTOOLS_LIB_OTHER_COMMON_CONNECTORS_GEN, prov, customArgs)
