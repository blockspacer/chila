...
#define CHILA_CODEX_TEXT_APP_CONNECTORS_GEN__CONN_ALIAS_AALINK_SEQ_MainWindow \
    ...
    ((actionDataList)(action_dataList))
...
#define CHILA_CODEX_TEXT_APP_CONNECTORS_GEN__CONN_ALIAS_AALINK_SEQ_TextEditor \
    ...
    ((action:dataList)(action_dataList))
...
<
        ...
        struct Ex_text_textEditor_registerAction
        {
            ...
            void operator()
            (
                const InArg0 &action_dataList_in,
                const InArg1 &action_object_in
            ) const
            {
                // Arguments -----------------------------------------------------------------
                CREATE_ARG(action_dataList, action_dataList);
                CREATE_ARG(action_object, action_object);
                ...
                (
                    ...
                    PASS_ARG(base_mainWindow, addAction, actionDataList, action_dataList),
                    PASS_ARG(base_mainWindow, addAction, action, action_object)
                );
